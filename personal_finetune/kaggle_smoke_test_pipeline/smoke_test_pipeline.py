...
# =========================================================================== #
# --- smoke test (not part of the deliverable file) -------------------------#
# =========================================================================== #
if __name__ == "__main__":
    ...
    samples = [
        "Patient: Jan Janssens, geboren 12-05-1980, 44 jaar. Adres: Kerkstraat 12, 9000 Gent. Tel 0475123456.",
        "INSZ 71030410130. Ondernemingsnummer BE0456987190. Contact: dr.willems@uzleuven.be. Meer info op www.uzleuven.be.",
        "AZ Delta Roeselare\nBrugsesteenweg 90, 8800 Roeselare\n\nBetreft: Nadia Verstraete\n\nMet vriendelijke groet,\nAZ Delta Roeselare - Dienst Radiologie",
    ]
    for i, text in enumerate(samples):
        spans = detect_pii(text, model, tokenizer)
        print(f"--- sample {i} ---")
        print(repr(text))
        for s in spans:
            print(f"  {s['label']:14s} {text[s['start']:s['end']]!r}")
        print()
    print("SMOKE TEST OK")
