#!/usr/bin/env python3
"""
validate_all_fr.py -- master validation pass across every dataset file
produced by the French pipeline. Run this after any regeneration.
...
Cross-file checks:
  - no id collisions between train_fr.jsonl / eval_real_fr.jsonl /
    eval_hard_extraction_fr.jsonl (the three files built with distinct case-id
    ranges: 0-6499, 900000+, 950000+)
"""
import json
import sys
...
FILES_WITH_IDS = [
    "train_fr.jsonl",
    "eval_real_fr.jsonl",
    "eval_hard_extraction_fr.jsonl",
]

FILES_TO_CHECK = FILES_WITH_IDS + [
    "train_augmented_fr.jsonl",
    "tamerbert_data_fr/train_filtered.jsonl",
    "tamerbert_data_fr/eval_indist.jsonl",
    "tamerbert_data_fr/eval_heldout_templates.jsonl",
]
