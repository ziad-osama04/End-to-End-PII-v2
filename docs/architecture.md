...
- **Production core — `MASKING_MODEL_VERSION=medroberta-nl-2`:** the fine-tuned
  Dutch clinical detector — Presidio + the `farahelmashad/pii-medroberta-nl-v2`
...
- **MLflow-packaged — `MODEL_URI=models:/pii-medroberta-nl-v2/<n>` or `runs:/…`:**
